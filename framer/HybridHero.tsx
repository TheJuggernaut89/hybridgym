...
/**
 * Hybrid Gym Hero Section
 * @framerSupportedLayoutWidth fixed
 * @framerSupportedLayoutHeight auto
 */
export default function HybridHero(props) {
    const {
        headline,
        highlightText,
        subheadline,
    ...
    const avatarStyle = {
        ...
        height: "28px",
        borderRadius: "50%",
        background: `linear-gradient(135deg, ${ctaColor}, #a8d900)`,
...
addPropertyControls(HybridHero, {
    headline: {
        title: "Headline",
