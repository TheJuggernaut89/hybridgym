        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
              Achieve your fitness goals with our{' '}
              <span className="text-[#c8ff00]">experienced</span> and{' '}
              <span className="text-[#c8ff00]">passionate</span> trainers
            </h2>
            ...
            <button className="inline-flex items-center gap-2 text-[#c8ff00] font-semibold hover:gap-4 transition-all">
